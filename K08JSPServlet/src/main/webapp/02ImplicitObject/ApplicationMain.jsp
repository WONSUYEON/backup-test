...
<!-- 
	이클립스에서는 우리가 직접 작성한 파일을 실행하는것이 아니고 
	metadata폴더하위에 프로젝트와 동일한 환경을 만들어서 복사본파일이 실행된다.
	따라서 아래의 물리적경로는 metadata하위의 경로가 출력되게 된다.
...
내장객체는 _jspService()메소드내에서 생성된 지역변수이므로 더 넓은 지역인
...
public String useImplicitObject(ServletContext app) {
	/*
	방법2 : 스크립트릿에서 메소드 호출시 application내장객체를
		매개변수로 전달해서 사용한다.
	*/
