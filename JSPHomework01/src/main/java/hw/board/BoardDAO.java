...
public class BoardDAO extends JDBConnect {
	...
	public BoardDAO(ServletContext application) {
		//부모쪽의 내장객체를 통해 web.xml에 작성된 컨텍스트 초기화 파라미터를 얻어온다.
		super(application);
	}
	
	/*
	board테이블에 저장된 게시물의 갯수를 카운트하기 위한 메소드.
	...
	*/
	...
	public int insertWrite(BoardDTO dto) {
		...
		try {
			...
			//동적쿼리문 실행을 위한 prepared statement객체 생성
